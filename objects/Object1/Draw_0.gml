...
if(active[0]) {
    var transform1 = matrix_build(window_get_width() / 2,window_get_height() / 2 + 128, 0, rotX, rotY, rotZ, scale,scale,scale);
...
if(active[2]) {
    var transform3 = matrix_build(window_get_width() / 2 - 384,window_get_height() / 2, 0, rotX, rotY, rotZ, scale,scale,scale);
    matrix_set(matrix_world, transform3);
    draw_icosahedron(obj3, tex3);
}

if(active[3]) {
    var transform4 = matrix_build(window_get_width() / 2 + 384,window_get_height() / 2, 0, rotX, rotY, rotZ, scale,scale,scale);
